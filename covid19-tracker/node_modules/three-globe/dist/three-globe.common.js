    ...
    threeDigest(state.hexPolygonsData, state.scene, {
      ...
      updateObj: function updateObj(obj, d) {
        ...
        var hexBins = h3Idxs.map(function (h3Idx) {
          ...
          var hexGeoJson = h3Js.h3ToGeoBoundary(h3Idx, true); // stitch longitudes at the anti-meridian
        ...
        var applyUpdate = function applyUpdate(td) {
          ...
          hexBins.forEach(function (h) {
            ...
            var hexGeom = new threeConicPolygonGeometry.ConicPolygonGeometry([geoJson], GLOBE_RADIUS, GLOBE_RADIUS * (1 + alt), false, true, false, curvatureResolution);
    ...
    threeDigest(state.pathsData, state.scene, {
      ...
      updateObj: function updateObj(group, path) {
        ...
        if (!group.children.length || useFatLine === (group.children[0].type === 'Line')) {
          ...
          var _obj = useFatLine ? new threeFatline.Line2(new threeFatline.LineGeometry(), new threeFatline.LineMaterial()) : new THREE$7.Line(new THREE$7.BufferGeometry(), sharedShaderMaterial.clone() // Separate material instance per object to have dedicated uniforms (but shared shaders)
          );
    ...
    var initGlobe = function initGlobe() {
      if (animateIn) {
        ...
        new TWEEN__default['default'].Tween({
          ...
          k: 1
        }, 600).easing(TWEEN__default['default'].Easing.Quadratic.Out).onUpdate(function (_ref12) {
          var k = _ref12.k;
        ...
        new TWEEN__default['default'].Tween({
          ...
          rot: 0
        }, 1200).easing(TWEEN__default['default'].Easing.Quintic.Out).onUpdate(function (_ref13) {
          var rot = _ref13.rot;
