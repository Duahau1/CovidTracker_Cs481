import { SphereGeometry, Color, LineBasicMaterial, LineSegments, Mesh, MeshPhongMaterial, TextureLoader, BufferGeometry, CylinderGeometry, CylinderBufferGeometry, FaceColors, Geometry, Matrix4, MeshBasicMaterial, MeshLambertMaterial, Object3D, Vector3, AdditiveBlending, CubicBezierCurve3, Curve, Float32BufferAttribute, Group, Line, QuadraticBezierCurve3, ShaderMaterial, TubeBufferGeometry, DoubleSide, NoColors, VertexColors, Font, CircleBufferGeometry, TextBufferGeometry, Vector2 } from 'three';
...
var THREE = window.THREE ? _objectSpread2(_objectSpread2({}, window.THREE), {}, {
  SphereGeometry: SphereGeometry // keep SphereGeometry from module for instance matching with three-glow-mesh
...
var GlobeLayerKapsule = Kapsule({
  ...
  stateInit: function stateInit() {
    ...
    var graticulesObj = new THREE.LineSegments(new GeoJsonGeometry(geoGraticule10(), GLOBE_RADIUS, 2), new THREE.LineBasicMaterial({
      color: 'lightgrey',
      transparent: true,
      opacity: 0.1
    }));
...
var LabelsLayerKapsule = Kapsule({
  ...
  update: function update(state) {
    ...
    var pxPerDeg = 2 * Math.PI * GLOBE_RADIUS / 360;
    var circleGeometry = new CircleBufferGeometry(1, 16);
